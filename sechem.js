...
const corsUrlLink = '<a href="' + corsUrl + '" target="_blank">' + corsUrl + '</a>'
        ...
        function sendPostRequest(url, data, headers, currentYearTreshold) {
            ...
            xmlHttp.onreadystatechange = function() { 
                ...
                // Raises error and solution to the user
                    ...
                    document.getElementById("sechem-result").innerHTML = `אם שגיאה זאת קופצת בעת חישוב הסכם של בן גוריון, יש להיכנס לקישור:<br> ${corsUrlLink} <br> ללחוץ על הכפתור: <br> 'Request temporary access to the demo server' <br>ולנסות שוב.<br> (חלק ממנגנון אבטחתי של אתר האוניברסיטה - כך תתאפשר לכם גישה ל-24 שעות)`;
                }
            }
        ...
        document.getElementById('formSwitch').addEventListener('change', function() {
            ...
            if (this.checked) {
                ...
                root.style.setProperty('--secondary-color', '#66a3ff');
            } else {
