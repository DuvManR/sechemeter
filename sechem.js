        ...
        function calculateTauFinal(firstSechem, mor) {
            ...
            let finalSechem = (firstSechem * 0.3148421445 + mor * 0.3722744907 + 432.0584815).toFixed(2);
        ...
        function calculateTechFinal(mor) {
        ...
        document.getElementById("sechem-universities").onchange = function() {
            ...
            let inputElement = document.getElementById("bottom-input");
        ...
        function extractCurrentYearTable(currentYearRow) {
            ...
            let currentYearTable = {"Year": currentYearRow[8], "data": {"huji": {'first': "", 'final': ""}, "tau": {'first': "", 'final': ""}, "tech": {'first': "", 'final': ""}, "biu": {'final': ""}}}
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        document.getElementById('sechem-switch').addEventListener('change', function() {
            ...
            if (this.checked) {
                ...
                changeSechemSelectOptions(finaltSechemOptions);
                tableElement.style.display = 'none';
                sechemLabelElement.style.display = 'none';
                document.getElementById("sechem-result").innerText = "סכם: 0";
            } else {
